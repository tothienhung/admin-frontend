  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="w-[450px] max-w-md p-8 space-y-6 bg-white rounded-md shadow-md">
        <h1 className="font-inter text-center text-black font-black text-[35px] leading-[14px]">
          DEVTO
        </h1>
        <div className="space-y-[6px]">
          <h1 className="text-[#5d586c] font-semibold font-inter text-[22px] leading-[30px]">
            Welcome!
          </h1>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            <label
              htmlFor="email"
              className="font-inter block text-[13px] font-normal text-[#6f6b7d]"
            >
              Email or Username
            </label>
            <input
          ...
          <div className="relative">
            <div className="flex items-center justify-between">
              ...
              <a
                ...
                className="font-inter text-[13px] text-indigo-500 hover:text-indigo-600"
              >
                Forgot Password?
              </a>
            </div>
          ...
          <div className="flex items-center">
            ...
            />
            <h1 className="ml-2 font-inter text-[15px] font-normal text-[#6f6b7d] leading-[22px]">
              Remember me
            </h1>
          </div>
          <button
          ...
          <div className="flex justify-center mt-8">
            <p className="font-inter text-[15px] font-normal text-[#6f6b7d] leading-[22px] ">
              ...
              <a
                href="/register"
                className="ml-1 text-blue-500 hover:text-blue-700 font-inter text-[15px] font-normal leading-[22px]"
              >
                Create an account
              </a>
            </p>
          ...
          <div className="flex items-center my-6">
            ...
            <span className="flex-shrink mx-4 text-gray-500 font-inter">
              or
            </span>
            <div className="flex-grow border-t border-gray-400"></div>
          </div>
